...
- [Explore built-in skills](#explore-built-in-skills)
...
- **[Your first skill →](your-first-skill.md)** — Build a real skill from scratch. Learn how to define tools, handle calls, add approval levels, and read per-skill config.
- **[Core concepts →](concepts.md)** — Understand the architecture: how skills, adapters, Human MCP, sessions, and memory work together.

---

← [Home](index.md) | [Your first skill →](your-first-skill.md)
