...
- **One-command install**: `curl -fsSL https://raw.githubusercontent.com/last9/mithai/master/install.sh | sh`
...
Step 2/6: Adapter
  ...
  ✓ Slack connected — workspace: "Example" — bot user: @mithai
...
Step 3/6: Kubernetes
  ...
  Available contexts:
    1. example-cluster (current)
    2. staging-gke
    3. prod-eks-us-east

  ✓ Context example-cluster: 42 nodes, 1,203 pods
...
Checks:
  ...
  ✓ kubectl: v1.29.2
  ✓ Cluster example-cluster: 42 nodes healthy
