...
```
  ...
  └──────────┘            │   │  │  │  └─────┬──────┘  └─────┬─────┘  │  │  │  │
                          ...
                          │   └──────────────────────────────────────────────┘  │
                          │                                                      │
                          │   Registry: container-registry.example                │
...
| Registry access | — | Push image to `container-registry.example` |
...
The default registry is `ghcr.io/example/mithai`. To use a different one:
...
```bash
kubectl -n mithai create secret generic private-registry \
...
```bash
kubectl -n mithai get secret private-registry
