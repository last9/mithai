...
def test_get_history_window_extracts_clickup_links():
        ...
        "messages": [
            {
                ...
                "attachments": [{"title_link": "https://app.clickup.com/t/86d3a2qb8"}],
                "ts": "1718000000.000100",
            },
        ],
        "response_metadata": {"next_cursor": ""},
    ...
    assert window["messages"][0]["links"] == ["https://app.clickup.com/t/86d3a2qb8"]
...
def test_extract_links_bare_urls_from_any_tool():
    ...
    window = _window_for_text(
        ...
        "https://linear.app/last9/issue/FDE-127 and "
        "https://app.clickup.com/t/86d3a2qb8"
    )
    assert window["messages"][0]["links"] == [
        "https://github.com/last9/mithai/pull/99",
        "https://linear.app/last9/issue/FDE-127",
        "https://app.clickup.com/t/86d3a2qb8",
    ]
...
def test_extract_links_dedupes_across_sources():
    ...
    client._client.conversations_history.return_value = {
        ...
        "messages": [
            {
                "username": "bot",
                "text": "<https://app.clickup.com/t/86d3a2qb8|task> https://app.clickup.com/t/86d3a2qb8",
                "attachments": [{"title_link": "https://app.clickup.com/t/86d3a2qb8"}],
                "ts": "1.0",
            },
        ],
